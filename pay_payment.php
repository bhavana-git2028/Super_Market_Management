...
<html>
	...
	<section class="container darkred-text">
		...
		<form class="white" action="pay_payment.php" method="POST">
			...
			<label>Bill no</label>
			<input type="number" name="bill_no" value="<?php echo ($_GET['bill_no']);?>" >
			...
			<label>Mode</label>
			<select name="mode" id="mode" style="display: block;margin-bottom: 20px;" >
	...
	<?php
	# echo $bill_db_details;



	#$sql23 = "SELECT * FROM cart WHERE bill_no = $billno";
